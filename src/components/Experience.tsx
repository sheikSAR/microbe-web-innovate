...
const Experience = () => {
  ...
  const getTypeColor = (type: string) => {
    const colorMap = {
      Research: "bg-teal-900/50 text-teal-300 border border-teal-500/30",
      Fieldwork: "bg-blue-900/50 text-blue-300 border border-blue-500/30",
      Teaching: "bg-green-900/50 text-green-300 border border-green-500/30"
    };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <Card key={index} className="shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-teal-500 bg-gray-900/80 backdrop-blur-sm border-gray-600/50">
              <CardHeader>
                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-teal-400 font-medium mb-1">{exp.organization}</div>
