...
const NCBISequences = () => {
  ...
  return (
    <section id="ncbi" className="py-20 bg-slate-900/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {sequences.map((seq, index) => (
            <Card key={index} className="glass-dark shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-blue-600 bg-slate-800/50 text-white">
              <CardHeader>
              ...
              <CardContent>
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full text-blue-400 border-blue-600 hover:bg-blue-900/30 bg-transparent"
        ...
        <div className="mt-12 text-center">
          <Card className="max-w-2xl mx-auto p-6 glass-dark bg-slate-800/50 text-white">
