      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <Card className="p-6 shadow-lg border-l-4 border-teal-500 bg-gray-800/80 backdrop-blur-sm border-gray-600/50">
              <CardContent className="p-0">
                <h3 className="text-2xl font-semibold text-white mb-4">My Research Journey</h3>
          ...
          <div className="space-y-6">
            <Card className="p-6 shadow-lg bg-gray-800/80 backdrop-blur-sm border-gray-600/50">
              <CardContent className="p-0">
                <h3 className="text-xl font-semibold text-white mb-4">Research Focus Areas</h3>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-teal-500 rounded-full"></div>
                    <span className="text-gray-300">Actinomycetes Research</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                    <span className="text-gray-300">Agricultural Microbiology</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                    <span className="text-gray-300">Bioinformatics Applications</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-teal-500 rounded-full"></div>
                    <span className="text-gray-300">16S rRNA Gene Sequencing</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
            ...
            <Card className="p-6 shadow-lg bg-gray-800/80 backdrop-blur-sm border-gray-600/50">
              <CardContent className="p-0">
                <h3 className="text-xl font-semibold text-white mb-4">Academic Journey</h3>
                <p className="text-gray-300 leading-relaxed">
