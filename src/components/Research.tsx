        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {publications.map((pub, index) => (
              <Card key={index} className="glass-dark shadow-lg hover:shadow-xl transition-shadow duration-300 h-full bg-slate-800/50 text-white">
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    <span className="px-3 py-1 bg-teal-900/50 text-teal-300 text-sm font-medium rounded-full border border-teal-600">
                      {pub.type}
                    </span>
                ...
                <CardContent className="flex flex-col justify-between flex-grow">
                  ...
                  {pub.doi && (
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full text-teal-400 border-teal-600 hover:bg-teal-900/30 bg-transparent"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {projects.map((project, index) => (
              <Card key={index} className="glass-dark shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-teal-600 bg-slate-800/50 text-white">
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
